...
<body><div align='center'><table id='wrapper' cellspacing='0' cellpadding='0'>
  <tr>
   ...
   $actions = array('home' => 'Home', 'group' => 'The Group', 'pans' => 'The Pans', 'booking' => 'Booking', 'media' => 'Media', 'premieres' => 'Premieres', 'requestgig' => 'Request Gig', 'requestgig2' => 'Request Gig'/*,  'recruiting' => 'Auditions'*/ ,'test' => "TEST");
	$p = (isset($_GET['p']) && in_array($_GET['p'], array_keys($actions))) ? $_GET['p'] : 'home';
	foreach ($actions as $key => $label) {
	  if ($key == "requestgig" || $key == "requestgig2" || $key == "test") {
            continue;
	  }
