...
<script type="text/javascript">
  function populateGigInfo(sql_result) {
    let firstDiv = sql_result.indexOf(smalldivider);
    let gigname = sql_result.substring(firstDiv + 1, sql_result.indexOf(smalldivider, firstDiv+1));
    document.getElementById('giginfo').innerHTML = 'Recommended Songs for ' + gigname;
  }
<?php echo "doajax('singlegig&gigid=".$_GET[gigid]."', populateGigInfo);" ?>
</script>
